...
public class TokenProvider {
     ...
     * @return 토큰 정보와 일치하는 User 객체 반환
     */
    public User getUser(String token) {
        String email = getEmail(token);

        return userRepository.findByEmail(email).orElseThrow(() -> new ApplicationException(ErrorCode.NOT_FOUND_EXCEPTION));
    }
